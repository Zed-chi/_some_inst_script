...
def parse_valid_promo_participians_from_comments(comments, likers, followers):
    users = []
...
if __name__ == "__main__":
    ...
    if username and post_url:
        ...
        valid_participians = parse_valid_promo_participians_from_comments(comments, likers, followers)
        valid_participians_names = set([user[1] for user in valid_participians])
        pprint("Пользователи выполнившие условия:\n{}".format(valid_participians_names))
    else:
